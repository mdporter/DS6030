...
- R: [Forecasting: Principles and Practice](https://otexts.com/fpp3/) 
  - uses the `fpp3` package ecosystem (`tsibble`, `fable`, `feasts`)
- Python: [Forecasting: Principles and Practice, the Pythonic Way](https://otexts.com/fpppy/) 
  - uses `statsforecast` and related libraries from Nixtla
  - AI tools (Claude, ChatGPT, Copilot) are allowed and encouraged for help with syntax and debugging
