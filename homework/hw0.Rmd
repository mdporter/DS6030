...
date: "Due: Tue Aug 31 | 2:55pm (ungraded)"
...
only needs to be done once. However you will need to use `library()` in
RMarkdown since it needs to be called everytime the Rmarkdown is
compiled.

## c. Install the course R package `R6030`

The course R Package is not hosted on CRAN, but on github. You can
install it with this command:

```{r, eval=FALSE}
remotes::install_github("mdporter/R6030")
```
