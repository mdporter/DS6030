...
## Michael D. Porter
## Created: Oct 2019
## For: Stat Learning (DS-6030) at University of Virginia
## Website: https://mdporter.github.io/DS6030
#####################################################################
...
gg_example = ggplot(data_train, aes(x,y)) +   # data and global aesthetics
  ...
  scale_x_continuous(breaks=seq(0, 1, by=.10)) # change x axis labels
